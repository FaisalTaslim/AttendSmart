document.addEventListener("DOMContentLoaded", () => {
  ...
  function floodSchoolSubjects(selectedClass) {
    resetSelect(MajorSelect2, "-- Select majors --"); // ← use resetSelect, not addPlaceholder
    resetSelect(MinorSelect2, "-- Select minors --");
    resetSelect(OptionalSelect2, "-- Select optionals --");
  ...
  loadOrganizations2(); // call at the end, inside DOMContentLoaded
